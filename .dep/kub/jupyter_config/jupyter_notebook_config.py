...
#  Choices: any of ['sha256', 'sha3_512', 'sha3_224', 'sha384', 'blake2b', 'blake2s', 'sha3_256', 'sha1', 'sha512', 'sha224', 'sha3_384', 'md5']
#  Default: 'sha256'
...
#it's location in the cuda12cudnn22 image is: /root/.jupyter/jupyter_notebook_config.py